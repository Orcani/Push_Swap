...
SRC = main_ps.c general_check.c display.c free.c push.c rev_rotate.c rotate.c sort_stacks.c sort_three.c swap.c init_a_to_b.c init_b_to_a.c stack_init.c stack_utils.c 
